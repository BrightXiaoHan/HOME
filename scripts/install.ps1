...
winget install -e --id Tencent.WeChat --silent --accept-source-agreements --accept-package-agreements
winget install -e --id Microsoft.WindowsTerminal --silent --accept-source-agreements --accept-package-agreements
winget install -e --id Kingsoft.WPSOffice.CN --silent --accept-source-agreements --accept-package-agreements
winget install -e --id Microsoft.PowerToys --silent --accept-source-agreements --accept-package-agreements
winget install -e --id Sogou.SogouInput --silent --accept-source-agreements --accept-package-agreements
winget install -e --id Alibaba.DingTalk --silent --accept-source-agreements --accept-package-agreements
winget install -e --id Valve.Steam --silent --accept-source-agreements --accept-package-agreements
winget install -e --id Alibaba.aDrive --silent --accept-source-agreements --accept-package-agreements
